function build_entity_matrix(t_inp_size, v_inp_size, mm_size, inp_seq_cardinality, dropout_p, in_table, obj_mappings_table, 
   ...
   first_token_attribute = nn.ReLU()(first_token_attribute)
   ...
   first_token_object = nn.ReLU()(first_token_object)
   ...
   for i=2,inp_seq_cardinality do
      ...
      token_attribute = nn.ReLU()(token_attribute)
      ...
      token_object = nn.ReLU()(token_object)
      -- putting together attribute and object 
      ...
      local normalized_similarity_profile, transformed_new_entity_mass = weight_distribute_function(raw_similarity_profile_to_entity_matrix, i, temperature, new_entity_mappings_table)
   ...
   return entity_matrix_table[inp_seq_cardinality], entity_creation_prob_table
end
...
-- adding token_object_mappings to shareList only now, after we also added to it the candidate image mappings
   ...
   query_attribute_1 = nn.ReLU()(query_attribute_1)
   ...
   query_attribute_2 = nn.ReLU()(query_attribute_2)
   ...
   local stable_entity_matrix, normalized_weight_table_and_output_distribution = build_entity_matrix(t_inp_size,v_inp_size,mm_size,inp_seq_cardinality,dropout_p,inputs,
