local function compute_dire_nomap_model_weight_distribution(raw_similarity_profile_to_entity_matrix, i, shared_raw_new_entity_mapping)
    ...
    local transformed_new_entity_mass = nn.Sigmoid()(raw_cumulative_similarity)
...
function entity_prediction_image_att_shared_neprob_nomap(t_inp_size,v_inp_size,mm_size,inp_seq_cardinality, temperature, dropout_p,use_cuda)
    return build_customize_model(t_inp_size,v_inp_size,mm_size,inp_seq_cardinality, compute_dire_nomap_model_weight_distribution, temperature, dropout_p,use_cuda)
end

function entity_prediction_image_att_shared_neprob_nomap_2matrices(t_inp_size,v_inp_size,mm_size,inp_seq_cardinality, temperature, dropout_p,use_cuda)
    return build_customize_model_with_2matrices(t_inp_size,v_inp_size,mm_size,inp_seq_cardinality, compute_dire_nomap_model_weight_distribution, temperature, dropout_p,use_cuda)
end