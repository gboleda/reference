...
local function add_new_input_and_create_double_mapping(inputs, input_size, mapping_size, dropout_p, share_mappings_select, 
   ...
   mapping_select = nn.Tanh()(mapping_select)
   mapping_compare = nn.Tanh()(mapping_compare)
...
function build_customize_model_with_2matrices_norm(t_inp_size,v_inp_size,mm_size,inp_seq_cardinality, weight_distribution_function, temperature, dropout_p,use_cuda)
   ...
   local entity_matrix_table_select, entity_matrix_table_compare = build_entity_libary_2matrices_norm(t_inp_size, v_inp_size, mm_size, inp_seq_cardinality, dropout_p, inputs, 
                             attribute_mappings_select, attribute_mappings_compare, token_object_mappings_select, 
                             token_object_mappings_compare, raw_new_entity_mass_mappings, temperature,
                             weight_distribution_function)
