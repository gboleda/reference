local function compute_dire_threshold_model_weight_distribution(raw_similarity_profile_to_entity_matrix, i, temperature, shared_raw_new_entity_mapping)
    ...
    transformed_new_entity_mass = nn.Threshold(0.3,0,false)(transformed_new_entity_mass)
...
function entity_prediction_image_att_shared_neprob_threshold(t_inp_size,v_inp_size,mm_size,inp_seq_cardinality, temperature, dropout_p,use_cuda)
    return build_customize_model(t_inp_size,v_inp_size,mm_size,inp_seq_cardinality, compute_dire_threshold_model_weight_distribution, temperature, dropout_p,use_cuda)
end

function entity_prediction_image_att_shared_neprob_threshold_metric_learning(t_inp_size,v_inp_size,mm_size,inp_seq_cardinality, temperature, dropout_p,use_cuda)
    return build_customize_model_metric_learning(t_inp_size,v_inp_size,mm_size,inp_seq_cardinality, compute_dire_threshold_model_weight_distribution, temperature, dropout_p,use_cuda)
end

function entity_prediction_image_att_shared_neprob_threshold_2matrices(t_inp_size,v_inp_size,mm_size,inp_seq_cardinality, temperature, dropout_p,use_cuda)
    return build_customize_model_with_2matrices(t_inp_size,v_inp_size,mm_size,inp_seq_cardinality, compute_dire_threshold_model_weight_distribution, temperature, dropout_p,use_cuda)
end
