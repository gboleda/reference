...
function entity_prediction_image_att_shared_neprob_onion(t_inp_size,v_inp_size,mm_size,inp_seq_cardinality,candidate_cardinality, temperature, dropout_p,use_cuda)
    return build_customize_model(t_inp_size,v_inp_size,mm_size,inp_seq_cardinality,candidate_cardinality, compute_lru_model_weight_distribution, temperature, dropout_p,use_cuda)
end