...
function build_entity_matrix(t_inp_size, v_inp_size, mm_size, inp_seq_cardinality, dropout_p, in_table, obj_mappings_table, att_mappings_table, metric_mapping_table) --, share_table)
   ...
   for i=2,inp_seq_cardinality do
      ...
      local metric_entity = nn.View(-1, i - 1, mm_size)(nn.LinearNB(mm_size, mm_size)(nn.View(-1, mm_size)(entity_matrix_table[i-1])))
...
function entity_prediction_image_att_shared_neprob_onion(t_inp_size,v_inp_size,mm_size,inp_seq_cardinality,candidate_cardinality,temperature,dropout_p,use_cuda)
   ...
   -- by temperature)
   local entity_query_metric = nn.View(-1, inp_seq_cardinality, mm_size)(nn.LinearNB(mm_size, mm_size)(nn.View(-1, mm_size)(stable_entity_matrix)))
   ...
   retrieved_entity_matrix = nn.PeekWithRate('retrieved_entity_matrix', 1000, 2)(retrieved_entity_matrix)
