...
function entity_prediction_image_att_shared_neprob_with_2_matrices(t_inp_size,v_inp_size,mm_size,inp_seq_cardinality,candidate_cardinality,nonlinearity,temperature,dropout_p,use_cuda)
   ...
   local query_attribute_1 = add_new_input_and_create_mapping(inputs,t_inp_size,mm_size,dropout_p,attribute_mappings)
   local query_attribute_2 = add_new_input_and_create_mapping(inputs,t_inp_size,mm_size,dropout_p,attribute_mappings)
   ...
   local first_object_token_vector = add_and_compute_token_vector(inputs,t_inp_size,v_inp_size,mm_size,dropout_p,attribute_mappings,token_object_mappings)
   ...
   for i=2,inp_seq_cardinality do
      ...
      local object_token_vector_flat = add_and_compute_token_vector(inputs,t_inp_size,v_inp_size,mm_size,dropout_p,attribute_mappings,token_object_mappings):annotate{name='object_token_' .. i}
      -- reshaping
