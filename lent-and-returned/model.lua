...
-- control TO BE DELETED
function entity_prediction_share_att1_att2_object(t_inp_size,v_inp_size,mm_size,inp_seq_cardinality)
...
-- control TO BE DELETED
function entity_prediction_share_query_tokens(t_inp_size,v_inp_size,mm_size,inp_seq_cardinality)
   ...
   table.insert(inputs,curr_input)
   local first_token_attribute = nn.LinearNB(t_inp_size,mm_size)(curr_input)
   -- sharing weights with words above
   ...
   for i=2,inp_seq_cardinality do
      ...
      table.insert(inputs,curr_input)
      local token_attribute = nn.LinearNB(t_inp_size,mm_size)(curr_input)
      -- sharing the word mapping weights with the words above
...
-- control TO BE DELETED
function entity_prediction_share_att1_object(t_inp_size,v_inp_size,mm_size,inp_seq_cardinality)
...
-- control TO BE DELETED
function entity_prediction_no_share(t_inp_size,v_inp_size,mm_size,inp_seq_cardinality)
