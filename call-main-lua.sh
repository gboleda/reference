...
datadir='/Users/gboleda/Desktop/data/reference/exp3-upto5-tiny'
...
th main.lua --model ff_ref --training_set_size 10 --validation_set_size 10 --test_set_size 10 --image_set_size 10 --word_embedding_file $datadir/word.dm --image_embedding_file $datadir/image.dm --protocol_prefix $datadir/stimuli --max_epochs 17 --min_epochs 17 --normalize_embeddings 1 --reference_size 300 --learning_rate 0.09 --momentum 0.09 --mini_batch_size 1
