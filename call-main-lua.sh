...
th main.lua --model ff_ref --training_set_size 40 --validation_set_size 42 --test_set_size 39 --image_set_size 125 --word_embedding_file $datadir/word.dm --image_embedding_file $datadir/image.dm --protocol_prefix $datadir/stimuli --max_epochs 1 --min_epochs 1 --normalize_embeddings 1 --reference_size 300 --learning_rate 0.09 --momentum 0.09 --mini_batch_size 1
